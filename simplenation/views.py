...
def search(request):
	...
	context_dict['search_active'] = False
	...
	if request.GET['search_item']:
		...
		if terms:
			...
			context_dict['not_found_message'] = 'Not found'

	else:
		context_dict['search_active'] = False
		context_dict['no_search_item_message'] = 'Please type in what you are looking for.'
		return HttpResponseRedirect("/simplenation/")
		
	return render(request, 'simplenation/base.html', context_dict) 
...
def tag_select(request):
	...
	if request.method == 'GET':
		number_of_tags_uncasted = request.GET['number_of_tags']
		number_of_tags = int(number_of_tags_uncasted)
		...
		if number_of_tags == 0:
			...
			tag_name_1 = request.GET['tag_name_1']
			...
			tag_name_1 = request.GET['tag_name_1']
			tag_name_2 = request.GET['tag_name_2']
			...
			tag_name_1 = request.GET['tag_name_1']
			tag_name_2 = request.GET['tag_name_2']
			tag_name_3 = request.GET['tag_name_3']
			...
			tag_name_2 = request.GET['tag_name_2']
			tag_name_3 = request.GET['tag_name_3']
			tag_name_4 = request.GET['tag_name_4']
			...
			tag_name_3 = request.GET['tag_name_3']
			tag_name_4 = request.GET['tag_name_4']
			tag_name_5 = request.GET['tag_name_5']
